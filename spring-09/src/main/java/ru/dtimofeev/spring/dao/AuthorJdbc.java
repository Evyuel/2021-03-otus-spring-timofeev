...
public class AuthorJdbc implements AuthorDao {
    ...
    public List<Author> getByIds(List<Long> ids) {
        ...
        return namedParameterJdbcOperations.query("select id,fullName from author where id in (:ids)", params, new AuthorMapper());
    }
    ...
    public Author getByFullName(String fullName) {
        ...
        return namedParameterJdbcOperations.queryForObject("select id,fullName from author where fullName=:fullName", params, new AuthorMapper());
    }

    @Override
    public List<Author> getAll() {
        return jdbcOperations.query("select id,fullName from author", new AuthorMapper());
    }
