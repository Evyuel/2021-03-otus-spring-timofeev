...
public class BookServiceImpl implements BookService {
    ...
    @Autowired
    public BookServiceImpl(BookRepository bookRepository, BookMapping bookMapping, MeterRegistry meterRegistry) {
    ...
    public BookDto save(BookDto bookdto) {
        ...
        this.meterRegistry.counter("books.new.today", "type", "book").increment(1);
