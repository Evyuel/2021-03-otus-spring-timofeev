...
public class AuthorServiceImpl implements AuthorService {
    ...
    private static final String KAFKA_TOPIC = "Authors";
    private final AuthorRepository authorRepository;
    private final AuthorMapping authorMapping;
    private final String objectName = "Author";
    private final KafkaTemplate<Long, Author> kafkaTemplate;

    @Autowired
    public AuthorServiceImpl(AuthorRepository authorRepository, AuthorMapping authorMapping, KafkaTemplate<Long, Author> kafkaTemplate) {
    ...
    public AuthorDto save(AuthorDto authordto) {
        ...
        kafkaTemplate.send(KAFKA_TOPIC, a.getId(), a);
