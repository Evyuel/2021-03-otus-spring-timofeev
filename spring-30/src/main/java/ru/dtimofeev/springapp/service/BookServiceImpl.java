...
public class BookServiceImpl implements BookService {
    ...
    @HystrixCommand(commandKey="bookKey", fallbackMethod="getSingleBook")
    @Override
    ...
    @HystrixCommand(commandKey="bookKey", fallbackMethod="getListOfBooks")
    @Override
    ...
    public BookDto getSingleBook(long id){
        return new BookDto(0,"This_default_Book",new GenreDto(0,"Default_Genre"),Collections.emptyList(),Collections.emptyList());
    }

    public List<BookDto> getListOfBooks(){
        return List.of(new BookDto(0,"This_Book_1",new GenreDto(0,"Default_Genre"),Collections.emptyList(),Collections.emptyList())
        ,new BookDto(0,"This_Book_2",new GenreDto(0,"Default_Genre"),Collections.emptyList(),Collections.emptyList()));
    }
